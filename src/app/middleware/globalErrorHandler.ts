...
//   // The global error handler should accept 4 arguments (err, req, res, next)
...
//     // Send the error response directly using res (no return needed)
//     res.status(statusCode).json({ statusCode, message, errorSources });
//   };